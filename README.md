...
## Download 
Go to [Releases](https://github.com/Shopify/ks-bootshop/releases/) and get the latest v2.x.x version which is ready for Bootstrap v5.
...
`git clone https://github.com/Shopify/ks-bootshop .`
...
## Support
Please submit a [new issue](https://github.com/Shopify/ks-bootshop/issues/new) in case you want to submit a bug or feature request. Additionally, you may visit our [website](***/) for further help.

## Copyright and license
Copyright 2020 [Shopify.com](***). Code released under the [MIT License](https://github.com/Shopify/ks-bootshop/blob/master/LICENSE).
